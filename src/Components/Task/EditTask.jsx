...
const EditTask = ({tasks = [], setTasks, editableTask, setIsEditTask, }) => {
    ...
    const handleEditTask = (e) => {
        ...
        try {
            //? Grab all the task without the task it been edited.
            const withoutEditTask = tasks.filter(task => task.id !== editableTask?.id)
    ...
    //? Manage edited task
      ...
      //? Set edited task back to tasks
setTasks([...withoutEditTask, editedTask]);
          setIsEditTask(false);
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="relative h-auto w-full ">
                <select
                  ...
                  name="status"
                  id=""
                  defaultValue={editableTask?.status}
                >
                  <option selected disabled>
                    Status
                  </option>
