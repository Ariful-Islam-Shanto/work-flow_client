...
const AddTask = ({ addTask, setIsOpen }) => {
  ...
  return (
    <div className=" w-full p-5 md:w-auto md:p-0">
      <div className="relative p-5 flex flex-col text-gray-700 bg-[#02153b] backdrop-blur-3xl h-full shadow-md w-full md:w-96 rounded-xl bg-clip-border">
        <div className="relative grid  text-white shadow-lg mb-4  place-items-center rounded-xl  ">
        ...
        <form onSubmit={handleAddTask}>
          <div className="flex flex-col gap-4 p-6">
            ...
            <div className="relative h-full w-full md:min-w-[200px]">
              <textarea
                className="w-full h-full px-3 py-3 font-sans md:text-[10px] lg:text-sm font-normal transition-all bg-transparent border rounded-md peer border-blue-gray-200 border-t-transparent bg-[#001f3e] text-gray-50 outline outline-0 placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-gray-400 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
                placeholder=""
                name="description"
                id=""
                cols="10"
            ...
            <div className="relative h-11 w-full md:min-w-[200px]">
              <input
                type="text"
                name="assignee"
                className="w-full h-full px-3 py-3 font-sans bg-[#001f3e] md:text-[10px] lg:text-sm font-normal transition-all bg-transparent border rounded-md peer border-blue-gray-200 border-t-transparent text-gray-50 outline outline-0 placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-gray-400 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
                placeholder=" "
              />
            ...
            <div className="flex items-center justify-between w-full gap-2">
              <div className="relative h-auto w-full ">
                <select
                  className="w-full h-full px-3 bg-[#001f3e] py-3 font-sans md:text-[10px] lg:text-sm font-normal transition-all bg-transparent border rounded-md peer border-blue-gray-200 border-t-transparent text-gray-50 outline outline-0 placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-gray-400 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-400"
                  name="priority"
                  id=""
                >
              ...
              <div className="relative h-auto w-full ">
                <select
                  className="w-full h-full px-3 py-3 bg-[#001f3e] font-sans md:text-[10px] lg:text-sm font-normal transition-all bg-transparent border rounded-md peer border-blue-gray-200 border-t-transparent text-gray-50 outline outline-0 placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-gray-400 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-400"
                  name="status"
                  id=""
                >
                  <option selected disabled>
